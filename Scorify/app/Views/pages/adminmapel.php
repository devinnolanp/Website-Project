...
<html lang="en">
   ...
   <body class="app sidebar-mini">
      ...
      <main class="app-content">
         ...
         <tr>
            <td><?php echo $mata_pelajaran['id_mata_pelajaran'] ?></td>
            <td><?php echo $mata_pelajaran['name'] ?></td>
            <td><button type="button" class="btn btn-md btn-primary fas fa-pencil-alt noUnderlineCustom text-white" data-toggle="modal" data-target="#editModal<?php echo $mata_pelajaran['id_mata_pelajaran'] ?>"></button>
         <a href="<?php echo base_url('adminhapusmapel?id='.$mata_pelajaran['id_mata_pelajaran']) ?>" type="button" class="btn btn-md btn-danger fas fa-trash noUnderlineCustom text-white"></a></td>
         </tr>
            <div class="modal fade" id="editModal<?php echo $mata_pelajaran['id_mata_pelajaran'] ?>" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
         ...
         <div class="modal-body">
               <form action="<?php echo base_url('admineditmapel') ?>" method="POST" enctype="multipart/form-data" method="POST" id="ModalForm">
               <div class="form-group">
            <label for="editId">ID</label>
               <input type="text" class="form-control" id="editId" placeholder="ID" value="<?php echo $mata_pelajaran['id_mata_pelajaran']; ?>" disabled>
            <input type="hidden" name="id_mata_pelajaran" value="<?php echo $mata_pelajaran['id_mata_pelajaran']; ?>">
         </div>
         <div class="form-group">
         <label for="editClass">Name</label>
            <input type="text" name="name_edit" class="form-control" id="editClass" placeholder="Name" value="<?php echo $mata_pelajaran['name']; ?>" required>
         </div>
      ...
      <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title" id="ModalLabel">Add New Course</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
               <div class="modal-body">
                  <form action="<?php echo base_url('adminaddmapel') ?>" method="post" enctype="multipart/form-data" id="ModalForm">
                     <div class="form-group">
                     ...
                     <div class="modal-footer">
                        ...
                        <button type="submit" id="saveModalButton" class="btn btn-primary">Add Course</button>
                     </div>
                  </form>
               </div>
            </div>
