         ...
         <ul class="app-nav">
            <li class="dropdown">
               ...
               <ul class="app-notification dropdown-menu dropdown-menu-right">
                  ...
                  <li class="app-notification__footer"><a href="#">Notifications.</a></li>
               </ul>
            </li>
            <li class="dropdown">
                        ...
                        <table class="table table-hover table-bordered" id="example">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td><button type="button" class="btn btn-md btn-primary fas fa-pencil-alt noUnderlineCustom text-white" data-toggle="modal" data-target="#editModal<?php echo $guru['id_user'] ?>"></button>
                                    <a type="button" href="<?php echo base_url("admindeleteuserguru?id=" . $guru['id_user'] . "&role=" . $id_role) ?>" class="btn btn-md btn-danger fas fa-trash noUnderlineCustom text-white"></a>
                                 </td>
                              </tr>
                              <div class="modal fade" id="editModal<?php echo $guru['id_user']; ?>" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                                 <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                       <div class="modal-header">
                                          <h5 class="modal-title" id="ModalLabel">Edit Guru</h5>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                          <span aria-hidden="true">&times;</span>
                                          </button>
                                       </div>
                                       <div class="modal-body">
                                          <form action="<?php echo base_url('admineditguru') ?>" method="POST" enctype="multipart/form-data" method="POST" id="ModalForm">
                                             <input type="hidden" id="editId" value="#">
                                             <div class="form-group">
                                                <label for="editId">ID</label>
                                                <input type="text" class="form-control" id="editId" placeholder="ID" value="<?php echo $guru['id_user']; ?>" disabled>
                                                <input type="hidden" name="id_edit" value="<?php echo $guru['id_user']; ?>">
                                             </div>
                                             <div class="form-group">
                                                <label for="editClass">Email</label>
                                                <input type="email" name="email_edit" class="form-control" id="editClass" placeholder="Email" value="<?php echo $guru['email']; ?>" disabled>
                                             </div>
                                             <div class="form-group">
                                                <label for="editClass">Name</label>
                                                <input type="text" name="name_edit" class="form-control" id="editClass" placeholder="Name" value="<?php echo $guru['name']; ?>" required>
                                             </div>
                                             <input type="hidden" name="role_id" value="<?php echo $guru['id_role'] ?>">
