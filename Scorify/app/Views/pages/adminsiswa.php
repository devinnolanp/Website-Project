                        ...
                        <table class="table table-hover table-bordered" id="example">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td><button type="button" class="btn btn-md btn-primary fas fa-pencil-alt noUnderlineCustom text-white" data-toggle="modal" data-target="#editModal<?php echo $siswa['id_user']; ?>"></button>
                                    <a type="button" href="<?php echo base_url("admindeleteusersiswa?id=" . $siswa['id_user'] . "&role=" . $id_role) ?>" class="btn btn-md btn-danger fas fa-trash noUnderlineCustom text-white"></a>
                                 </td>
                              </tr>
                              <div class="modal fade" id="editModal<?php echo $siswa['id_user']; ?>" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                                 <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                       ...
                                       <div class="modal-body">
                                          <form action="<?php echo base_url('admineditsiswa') ?>" method="POST" enctype="multipart/form-data" method="POST" id="ModalForm">
                                             <input type="hidden" id="editId" value="terserah">
                                             <div class="form-group">
                                                <label for="editId">ID</label>
                                                <input type="text" class="form-control" id="editId" placeholder="ID" value="<?php echo $siswa['id_user']; ?>" disabled>
                                                <input type="hidden" name="id_edit" value="<?php echo $siswa['id_user']; ?>">
                                             </div>
                                             <div class="form-group">
                                                <label for="editClass">Email</label>
                                                <input type="email" name="email_edit" class="form-control" id="editClass" placeholder="Email" value="<?php echo $siswa['email']; ?>" disabled>
                                             </div>
                                             <div class="form-group">
                                                <label for="editClass">Name</label>
                                                <input type="text" name="name_edit" class="form-control" id="editClass" placeholder="Name" value="<?php echo $siswa['name']; ?>" required>
                                             </div>
                                             <input type="hidden" name="role_id" value="<?php echo $siswa['id_role'] ?>">
