         ...
         <ul class="app-menu">
            ...
            <li class="treeview">
               ...
               <ul class="treeview-menu">
                  ...
                  <li><a class="treeview-item" href="guru?id=<?php echo $kelas['id_kelas'] ?>"><i class="icon fas fa-greater-than"></i><?php echo $kelas['id_kelas'] . ' - ' . $kelas['name_kelas'] ?></a></li>
                  <?php } ?>
               </ul>
            </li>
         </ul>
         ...
         <div class="tab-content">
            ...
            <div class="tab-pane fade" id="user-settings">
               <div class="tile user-settings">
                  ...
                  <form action="siswaupdateprofile" method="post" enctype="multipart/form-data">
                     <div class="row">
                        <div class="col-md-12 mb-4 text-center">
                        </div>
                        <div class="col-md-12 mb-4">
         ...
         if ($("#ajax_form_request_permission").length > 0) {
             $("#ajax_form_request_permission").validate({
                 submitHandler: function(form) {
                     ...
                     $.ajax({
                         url: "<?php echo base_url('siswaizinedit') ?>",
                         type: "POST",
